...
public class SearchStudentActivity extends AppCompatActivity {
    ...
    private Spinner spinner_si_do,spinner_gu_gun,spinner_gender,spinner_study_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(spinner_si_do.getSelectedItemPosition()>0){
                    ...
                    sessionManager.editor.putString("spinner_student_location_string",location);
                } else {
                    sessionManager.editor.putString("spinner_student_location_string",null);
                }

                sessionManager.editor.putString("student_keyword",editText_keyword.getText().toString().trim());

                sessionManager.editor.putInt("spinner_student_study_type",spinner_study_type.getSelectedItemPosition());
                sessionManager.editor.putString("spinner_student_study_type_string",spinner_study_type.getSelectedItem().toString());

                sessionManager.editor.putInt("spinner_student_gender",spinner_gender.getSelectedItemPosition());
                sessionManager.editor.putString("spinner_student_gender_string",spinner_gender.getSelectedItem().toString());

                sessionManager.editor.putInt("spinner_student_si_do",spinner_si_do.getSelectedItemPosition());
                sessionManager.editor.putInt("spinner_student_gu_gun",spinner_gu_gun.getSelectedItemPosition());
        ...
        editText_keyword.setText(sessionManager.sharedPreferences.getString("student_keyword", ""));
        spinner_study_type.setSelection(sessionManager.sharedPreferences.getInt("spinner_student_study_type", 0));
        spinner_gender.setSelection(sessionManager.sharedPreferences.getInt("spinner_student_gender", 0));
        spinner_si_do.setSelection(sessionManager.sharedPreferences.getInt("spinner_student_si_do", 0));
    ...
    private void setSpinnerAdapterItem(int array_resource) {
        ...
        spinner_gu_gun.setSelection(sessionManager.sharedPreferences.getInt("spinner_student_gu_gun", 0));
    }
}