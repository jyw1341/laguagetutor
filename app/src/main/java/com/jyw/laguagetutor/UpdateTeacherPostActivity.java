...
public class UpdateTeacherPostActivity extends AppCompatActivity {

    EditText editText_post_title,editText_post_subject,editText_post_schedule,editText_post_description;
    ...
    private static final String BASE_URL = "/server1/update_teacher_post.php";
    private static final String TAG = UpdateStudentPostActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_teacher_post);
